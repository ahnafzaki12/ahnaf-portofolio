...
export default function ProjectHero({ active, setActive }: ProjectHeroProps) {
    return (
        <section
            id="project"
            ...
            <div className="mx-auto flex w-full max-w-8xl flex-col gap-8 px-6 md:gap-10 md:px-12 lg:px-16">
                ...
                <div className="flex flex-col gap-4 max-w-2xl">
                    ...
                    <p className="text-sm leading-relaxed text-portfolio-muted max-w-xl">
                        A curated collection of my work, bridging the gap between information systems,
                        data science models, and scalable software development.
                    </p>
                </div>

                {/* 2. MIDDLE — Radio Button Filter Group (Ghost Pill) */}
        ...
        `}
                ...
                <div className="flex items-center gap-4 pt-4 w-full">
                    ...
                    <span className="text-[10px] tracking-[0.25em] text-white/20 uppercase whitespace-nowrap">
                        {active === "all" ? "All Projects" : FILTERS.find((f) => f.value === active)?.label}
                    </span>
                    <div className="h-px flex-1 bg-gradient-to-r from-transparent via-white/10 to-transparent" />
                </div>
