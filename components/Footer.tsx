...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/10 px-6 py-6 md:px-12 lg:px-16">
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-center gap-5 sm:flex-row sm:justify-between sm:gap-4">
